...
contract Handler is Test {
    ...
    function mintDsc (uint256 amount, uint256 addressSeed) public {
        ...
        (uint256 totalDscMinted, uint256 collateralValueInUsd) = dsce.getAccountInformatin(msg.sender);
    ...
    function depositCollateral(address collateralSeed, uint256 amountCollateral) public {
        ...
        amountCollateral = bound(amountCollateral, MAX_DEPOSIT_SIZE);
        vm.startPrank(msg.sender);
    ...
    function redeemCollateral(uint256 collateralSeed, uint256 amountCollateral) public {
        ...
        dsce.redeemCollateral(collateralSeed, amountCollateral);
    }
